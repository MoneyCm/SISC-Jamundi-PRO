...
class PdfReportService:
    @staticmethod
    def generate_pdf(db: Session, report: ReportRun):
        """
        ...
        filename = f"Reporte_{report.report_type}_{report.period_key}_{report.id}.pdf"
        ...
        # 3. Preparar HTML
        html_content = PdfReportService._build_html(report, content_hash)
        
        # 4. Generar PDF con WeasyPrint
        # Definimos estilos CSS inline o via objeto CSS
        css = CSS(string="""
    ...
    @staticmethod
    def _build_html(report: ReportRun, content_hash: str):
        ...
        <div class="audit-seal">
            ...
            <div class="audit-line"><span class="audit-label">Tipo:</span> <span class="audit-value">{report.report_type}</span></div>
            <div class="audit-line"><span class="audit-label">Fuente:</span> <span class="audit-value">{report.source_id}</span></div>
            <div class="audit-line"><span class="audit-label">Periodo:</span> <span class="audit-value">{report.period_key}</span></div>
            <div class="audit-line"><span class="audit-label">Generado (UTC):</span> <span class="audit-value">{report.generated_at.isoformat()}</span></div>
            <div class="audit-line"><span class="audit-label">Hash Integridad (SHA256):</span> <span class="audit-value">{content_hash}</span></div>
            <div class="audit-line"><span class="audit-label">Versión Pipeline:</span> <span class="audit-value">v1.2.0-STABLE</span></div>
            {forced_html}
        </div>
        """
